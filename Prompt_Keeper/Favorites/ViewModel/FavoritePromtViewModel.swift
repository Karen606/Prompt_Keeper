...
class FavoritePromtViewModel {
    static let shared = FavoritePromtViewModel()
    ...
    func fetchData() {
        CoreDataManager.shared.fetchFavoritePrompts { [weak self] prompts, _ in
